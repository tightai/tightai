...
class Version(Lookup, BaseObject):
    ...
    def open(self):
        ...
        if url == None or details['deployed'] == False:
            raise Exception("This version has not been deployed yet. Run `.push()` to push a deployment or `.status()` to refresh deployment status.")
